...
- A Google account with the BirdCLEF 2026 dataset already downloaded and placed in Google Drive (see [`datasets/birdclef_2026/about_dataset.md`](datasets/birdclef_2026/about_dataset.md) for download instructions).
